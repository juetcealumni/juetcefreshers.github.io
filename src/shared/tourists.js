...
import logo2 from "../images/victoria.jpg"
...
export const touristsdetails=[

  {
    ...
    body:"Felling bored? Feeling stressed? It’s the time to hang around the famous tourist spot Victoria Memorial. The Victoria Memorial is a large marble building in Kolkata, West Bengal, India, which was built between 1906 and 1921. It is dedicated to the memory of Queen Victoria, then Empress of India, and is now a museum and tourist destination under the auspices of the Ministry of Culture. It takes less than 15 minutes to reach Victoria Memorial by bus or cab. Let’s Enjoy…",
    alt:"victoria picture"
  },
    {
    id:2,
    src:logo3,
    heading:"Indian Museum" ,
    body:" The Indian Museum in Kolkata, West Bengal, India, also referred to as the Imperial Museum at Calcutta in colonial-era texts, is the ninth oldest museum of the world, oldest museum in India and the largest museum in India It has rare collections of antiques, armour and ornaments, fossils, skeletons, mummies and Mughal paintings. It was founded by the Asiatic Society of Bengal in Kolkata (Calcutta), India, in 1814. The founder curator was Nathaniel Wallich, a Danish botanist.",
    alt:"museum picture"
  },
  {
    id:3,
