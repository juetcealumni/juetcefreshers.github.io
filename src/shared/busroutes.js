...
export const busroutes=[
  {
    ...
    body:'The Howrah Railway Station is 7km from IIEST campus It is one of the four major railway stations in and around Kolkata. To reach there, take any of the buses - Howrah esplanade mini, Bus-55 etc It will take about 20 minutes',
    alt:'Howrah station',
    src:logo1
  },
  {
    ...
    body:'Sealdah station is the main station for local trains and also serves express trains. At a distance of about 11 km from IIEST, the best transport is the B.Garden - Sealdah bus. It take around 40 minutes to reach the destination.',
    alt:'Sealdah station',
    src:logo3
  },
  {
