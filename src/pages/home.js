...
import picture from '../images/jucampus.jpg'
    ...
    <div className="fade">
      <div className="intro">
        <div className="intro-text">
          <h2>Heartiest welcome to all Freshers</h2>
          <p>Welcome to the Department of Electronics and Telecommunication Engineering of Jadavpur University,
          The Department ‘Tele-Communication Engineering ’ was born under the leadership of Prof. J. S. Chatterjee during 1957,and
          till now the department is continuing it's legacy.
          ...
          <div className="col-12 col-md-4 ">
            <div className="row">
              ...
              {/* <div className="col-12">
                <a href="/" target="blank"><img src={blog} className="blog" alt="blog"></img></a>
              </div> */}
            </div>
          </div>
          <div className="col-12 col-md-8">
            <img className="slideshow" src={picture} alt="  campus" />
          </div>
        </div>
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-10">
            <h6>A website to gather all important informations regarding admission and joining to institute</h6>
            <p>Since university is closed for a long time due to COVID-19 Pandemic so it is a initiative from seniors of the Department of Electronics and Telecommunication Engineering to gather all admission related and other informations at a single place.
              N.B. This website is not an official website of JU
            </p>
          </div>
          <div className="col-2 mt-5">
            <a role="button" className=" btn btn-success" href="/"><i className="fa fa-phone fa-lg"></i></a>
          </div>
        </div>
      </div>
    </div>
